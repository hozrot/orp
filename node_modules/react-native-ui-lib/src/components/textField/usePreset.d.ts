...
export default function usePreset({ preset, ...props }: InternalTextFieldProps): {
    ...
    validationIcon?: import("../image").ImageSourceType | undefined;
